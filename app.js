(function() {
	...
	var generate = function() {
		...
		if(security.checked) {
			appendSource(['']);
			appendSource(['deb', arch, 'https://security.debian.org/debian-security', rel + '/updates', comps]);
			if(src.checked) appendSource(['deb-src', arch, 'https://security.debian.org/debian-security', rel + '/updates', comps]);
		}
